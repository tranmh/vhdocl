...
the VHDL style by Minh Cuong Tran, but now VHDocL itself inserts tags with CSS
classes.  Their appearance is determined by a default CSS file and can be
...
source pages, so you can edit it by clicking on the link if you have the file
associations of your browser set accordingly.
...
instances, ports, generics, constants and attributes.

Most likely this will be treated equally as B<identifier>.
